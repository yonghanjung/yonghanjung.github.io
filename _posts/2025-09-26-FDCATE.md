...
- **Quasi-oracle rate**: An oracle rate is the achievable rate for the target parameter when the true nuisances are given. The _quasi_-oracle rate is the same as oracle rate from our _estimated_ nuisances.
